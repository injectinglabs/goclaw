...
func buildBrowserPageSection() []string {
	return []string{
		...
		"",
		"Do not call refresh_page_content twice in a row on an unchanged page. If the snapshot lacks the element you need, tell the user — retrying will return the same result.",
		"",
